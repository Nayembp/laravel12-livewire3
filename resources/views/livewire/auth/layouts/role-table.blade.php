      ...
      <table class="min-w-full table-auto">
        <thead class="border-y border-gray-100 py-3 dark:border-gray-800">
          <tr>
            ...
            <th class="py-3 font-normal text-left whitespace-nowrap">Permissions</th>
            <th class="py-3 font-normal text-left whitespace-nowrap">Actions</th>
          </tr>
        </thead>
            ...
            <tr class="align-top">
              ...
              <td class="py-4 px-3 whitespace-nowrap">
                <div class="flex gap-2">
                  ...
                  <flux:button size="xs" variant="danger" icon="trash" wire:click="deleteRole({{ $role->id }})" onclick="return confirm('Are you sure you want to delete this role?')" aria-label="Delete Role" />
